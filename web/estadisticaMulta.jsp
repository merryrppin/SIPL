<%-- 
    Document   : estadisticaMulta
    Created on : 9/03/2014, 04:28:07 PM
    Author     : Samy
--%>
...
<html>
    <head>
        ...
        <title>Estadísticas Multa</title>
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6">
                <form name="Estadistica" class="form-horizontal" action="graficarM.jsp?accion=2" method="POST" onsubmit="return validarForm(this);">

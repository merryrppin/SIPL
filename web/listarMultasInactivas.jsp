        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-10">
                <table align="center">
                    <tr>
                        <td>
                            <button class="btn btn-danger" type="button" onclick="location.href = 'listarMultas.jsp?accion=1'" style='width:150px;'>Atrás</button>
                        </td>
                    </tr>
                </table>
                <br>
                    ...
                    <table class="table table-striped" align="center">
                        ...
                        <tr>
                            <td colspan="6" align="center">
                                <input class="btn btn-info" type="button" value="Generar PDF" onclick="fijarURL('GenerarPDF.jsp?accion=15', this.form)" style='width:200px;'/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6" align="center">

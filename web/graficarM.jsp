                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <%
                                    String genPDF = "multa;Gráfica de Multas";
                                    String f1 = o[4] + "/" + o[5] + "/" + o[6] + " 00:00:00";
                                    String f2 = o[1] + "/" + o[2] + "/" + o[3] + " 23:59:59";
                                    String[] env = o[0].split("Multas");
                                ...
                                <input class="btn btn-info" type="button" value="Generar PDF" onclick="fijarURL('GenerarPDF.jsp?accion=9', this.form)" style='width:150px;'/>
                            </td>
                        </tr>
                    </table>
                </div>

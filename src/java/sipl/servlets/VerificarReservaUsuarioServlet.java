 ...
 * @author WM
 */
public class VerificarReservaUsuarioServlet extends HttpServlet {
        ...
        if (usu != null) {
            if (res == null) {
                out.print("<b>" + usu.getNombre() + " " + usu.getApellido() + " identificado con el código "
                        + usu.getCodigo() + " no tiene Reservas activas" + "</b>");
            } else {
                ...
                mes++;
                out.print("<b>" + usu.getNombre() + " " + usu.getApellido() + " identificado con el código "
                        + usu.getCodigo() + " tiene una reserva que caducara el " + cal2.get(Calendar.YEAR)
